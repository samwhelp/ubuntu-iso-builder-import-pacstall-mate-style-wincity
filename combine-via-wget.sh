...
REF_WORK_DIR_PATH="${HOME}/work/ubuntu-iso-builder-import-pacstall-mate-style-wincity"
...
echo "[Next Step]: cd ~/work/ubuntu-iso-builder-import-pacstall-mate-style-wincity/iso-profile
"
echo
